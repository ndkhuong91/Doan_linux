  	...
  	<div class="main_content">
        ...
        <!-- Những món ăn được chon nhiều nhất-->
  		<div class="wpb_wrapper">
			<div class="section-title">
				<center>
					<h2>Món ăn được chọn nhiều nhất</h2>
				</center>
			</div>
		</div>
		<!--  Món 1 -->
		<div class="main_sub_content_1">
		  		<div class="sub_content">
		  			...
		  			<div class="dicription">
		  				<p> Đây là phần giới thiệu ngắn về món ăn
		  				Đây là phần giới thiệu ngắn về món ăn
		  			Đây là phần giới thiệu ngắn về món ăn</p>
		  			</div>
		  		</div>
		...
		<form action="tim.php" method="get">
  		...
  		<div>
  			...
  			<ul class="search">
  				...
  				<li><input class="text" type="text" width="300px" name="text_dc"></li>
  			</ul>
  			...
  			<ul class="search">
  				...
  				<li><input class="text" type="text" width="300px" name="text_m"></li>
  			</ul>
  			...
  			<ul class="search">
  				...
  				<!--<li><input class="text" type="text" width="300px" name="text_lm"></li>-->
  			</ul>
  			...
  			<ul class="search">
  				...
  				<li><label>Từ </label><input class="tu" type="text" name="text_giatu"></li>
			...
			<ul class="search">
  				...
  				<li><label>Từ </label><input class="tu" type="text" name="text_giotu"></li>
  				<li><label>đến </label><input class="den" type="text" name="text_gioden"></li>
  			</ul>
  			<center><button type="submit" formaction="tim.php">Tìm</button></center>
